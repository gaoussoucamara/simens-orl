...
class StatistiqueForm extends Form{
	...
	public function __construct() {
		...
		$this->add ( array (
				'name' => 'id_sous_dossier_frequence',
				'type' => 'Select',
				'options' => array (
						'label' => iconv('ISO-8859-1', 'UTF-8','Choix du sous dossier'),
				),
				'attributes' => array (
						'registerInArrrayValidator' => true,
						'onchange' => 'getInformationsSousDossierFrequence(this.value)',
						'id' => 'id_sous_dossier_frequence',
						'class' => 'select-element',
				)
		) );
		...
		$this->add ( array (
				...
				'type' => 'number',
				'options' => array (
						'label' => iconv('ISO-8859-1', 'UTF-8','Age min(0)'),
				),
				'attributes' => array (
						'registerInArrrayValidator' => true,
		...
		$this->add ( array (
				...
				'attributes' => array (
						'registerInArrrayValidator' => true,
						'onchange' => 'getListeAgeRapMin(this.value)',
						'id' =>'age_min_rapport',
						'min' => 0,
						'max' => 150,
		...
		$this->add ( array (
				...
				'attributes' => array (
						'registerInArrrayValidator' => true,
						'onchange' => 'getListeAgeRapMax(this.value)',
						'id' =>'age_max_rapport',
						'min' => 1,
						'max' => 150,
				)
		...
		$this->add ( array (
				...
				'attributes' => array (
				'registerInArrrayValidator' => true,
		        'onchange' => 'getInformationsDiagnosticGenre(this.value)',
						'id' => 'SEXE',
						'required' => true,
						'tabindex' => 3,
						'class' => 'select-element',
