...
// 		var_dump($output); exit();
	...
	public function statistiquesImprimeesAction() {
		...
		public function statistiquesDiagnosticsImprimeesAction() {
			...
			if($age_min_rapport != 0 && $age_max_rapport != 0){ /*L'âge est selectionnée*/
				...
				if($id_sous_dossier == 0){
					...
					if($sexe == ''){
						if($date_debut && $date_fin){
						            $periodeDiagnostic[0] = $date_debut;
						            $periodeDiagnostic[1] = $date_fin;
						/*non*/		$listeDiagnostic = $this->getPatientTable()->getListeDiagnosticPourUnePeriodeParAge($date_debut, $date_fin, $age_min_rapport, $age_max_rapport);
								
						}else{
									$periodeDiagnostic[0] = $date_debut;
							        $periodeDiagnostic[1] = $date_fin;
							/*non*/	$listeDiagnostic = $this->getPatientTable()->getListeDiagnosticParAge($age_min_rapport, $age_max_rapport);
					...
					if($sexe){
						...
						if($date_debut && $date_fin){
									$periodeDiagnostic[0] = $date_debut;
							        $periodeDiagnostic[1] = $date_fin;
							/*non*/	$listeDiagnostic = $this->getPatientTable()->getListeDiagnosticParSexePourUnePeriodeParAge($sexe, $date_debut, $date_fin, $age_min_rapport, $age_max_rapport);
						}else{
									$periodeDiagnostic[0] = $date_debut;
									$periodeDiagnostic[1] = $date_fin;
			 /*non 1 pt d'écart*/	$listeDiagnostic = $this->getPatientTable()->getListeDiagnosticParSexeParAge($sexe, $age_min_rapport, $age_max_rapport);
						}
					}
				...
				if($id_sous_dossier != 0){
					...
					if($sexe){
						...
						if($date_debut && $date_fin){
							...
							$periodeDiagnostic[0] = $date_debut;
							$periodeDiagnostic[1] = $date_fin;
			/*non*/		    $listeDiagnostic = $this->getPatientTable()->getListeDiagnosticParSousDossierParSexePourUnePeriodeParAge($id_sous_dossier, $sexe, $date_debut, $date_fin, $age_min_rapport, $age_max_rapport);
					...
					if($date_debut && $date_fin){
							$periodeDiagnostic[0] = $date_debut;
							$periodeDiagnostic[1] = $date_fin;
			/*non*/			$listeDiagnostic = $this->getPatientTable()->getListeDiagnosticParSousDossierPourUnePeriodeParAge($id_sous_dossier, $date_debut, $date_fin, $age_min_rapport, $age_max_rapport);
					}else
			...
			if ($sexe) { /*Le genre est selectionné*/
		...
		public function statistiquesFrequenceImprimeesAction() {
			...
			if($id_sous_dossier_frequence != 0){ /*Un sous dossier est selectionné*/
