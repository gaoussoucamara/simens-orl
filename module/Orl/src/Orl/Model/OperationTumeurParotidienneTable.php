...
class OperationTumeurParotidienneTable
{
	...
	public function addOperationTumeurParotidienne($data, $id_cons, $id_employe_e)
	{
		...
		$donnees = array(
			...
			'abords_paro' => $data->abords_paro,
			'decouvertes_paro' => $data->decouvertes_paro,
			'gestes_paro' => $data->gestes_paro,
			'fermeture_paro' => $data->fermeture_paro,
			'date_sortie' => ($data->date_sortie) ? $data->date_sortie : null,
