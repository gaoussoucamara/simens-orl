...
class ExamenCliniquece {
	...
	public function exchangeArray($data) {
		...
		$this->fosse_nasale = (! empty ( $data ['fosse_nasale'] )) ? $data ['fosse_nasale'] : null;
		$this->pharynx_corps = (! empty ( $data ['pharynx_corps'] )) ? $data ['pharynx_corps'] : null;
		$this->vri_corps = (! empty ( $data ['vri_corps'] )) ? $data ['vri_corps'] : null;
