				...
				if ($aColumns[$i] != ' ') {
					...
					/*
						...
						if ($this->getRvProgrammer($aRow['id_rv'])) {
							$html .= "<infoBulleVue>";
							$html .= "<span style='display: inline; margin-right: 10%; font-family: Bradley Hand ITC; font-weight: bold; color: rgb(24, 153, 121);' title='Rv Programmer' > RP </span></infoBulleVue>";
						} else {
							$html .= "<infoBulleVue>";
							$html .= "<span style='display: inline; margin-right: 10%; font-family: Bradley Hand ITC; font-weight: bold; color: rgb(24, 153, 121);' title='Rv Consult&eacute;' > RC </span></infoBulleVue>";
						}
			...
			for ($i = 0; $i < count($aColumns); $i++) {
				if ($aColumns[$i] != ' ') {
					...
					*/ else if ($aColumns[$i] == 'Age') {
						...
						$html = "<a class='btn btn-sm btn-success' href='" . $tabURI[0] . "public/secretariat/info-patient-rv?id_cons=" . $aRow['Id_cons'] . "&id_patient=" . $aRow[$aColumns[$i]] . "'> ";
