...
class OperationTumeurParotidienne
{
	...
	public $cro_paro;
	public $abords_paro;
	public $decouvertes_paro;
	public $gestes_paro;
	public $fermeture_paro;
	public $date_sortie;
	...
	public function exchangeArray($data)
	{
		...
		$this->abords_paro = (!empty($data['abords_paro'])) ? $data['abords_paro'] : null;
		$this->decouvertes_paro = (!empty($data['decouvertes_paro'])) ? $data['decouvertes_paro'] : null;
		$this->gestes_paro = (!empty($data['gestes_paro'])) ? $data['gestes_paro'] : null;
		$this->fermeture_paro = (!empty($data['fermeture_paro'])) ? $data['fermeture_paro'] : null;
