		...
		while($this->_yPosition > 70 ) {
			...
			if($i==3){
				...
				$this->_page->drawText('Intervention prévue :   ',
						...
						$this->_yPosition);
				$this->_page->setFont($this->_policeContenu, 14);
				$this->_page->drawText(iconv ( 'UTF-8', 'ISO-8859-1', $this->_DonneesDemande['intervention_prevue'] ),
			...
			if($i==5){
				...
				$this->_page->drawText('VPA N° :  ',
						...
						$this->_yPosition);
				$this->_page->setFont($this->_policeContenu, 14);
						$this->_page->drawText(iconv ( 'UTF-8', 'ISO-8859-1', $this->_DonneesDemande['numero_vpa'] ),
						$this->_leftMargin+60,
						$this->_yPosition);
			}
			if($i==6){
			...
			if($i==8){
				$this->_page->setFont($this->_policeContenu, 14);
				$this->_page->drawText(iconv ( 'UTF-8', 'ISO-8859-1', $tab2[3] ),
						$this->_leftMargin,
						$this->_yPosition);
			}
			$i++;
