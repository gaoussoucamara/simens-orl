	...
	protected  function getNoteTC()
	{
		...
		for ($i = 1; $i < 18; $i++) {
			...
			if ($i == 1) {
				...
				$this->_page->setFont($this->_policeContenu, 12);
				$this->_page->drawText(
					$this->_DonneesDemande['intervention_prevue'],
				...
				$this->_page->drawText(
					iconv('UTF-8', 'ISO-8859-1', $this->_DonneesDemande['resultatTypeIntervention']),
				...
				$this->_page->setFont($this->_policeContenu, 13);
				$this->_page->drawText(
					$this->_DonneesDemande['resultatNumeroVPA'],
					$this->_leftMargin + 60,
					$this->_yPosition
				);
			} else 
