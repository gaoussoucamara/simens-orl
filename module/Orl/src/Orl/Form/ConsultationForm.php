...
class ConsultationForm extends Form
{
	...
	public function __construct($name = null)
	{
		...
		$this->add(array(
			...
			'type' => 'Text',
			'options' => array(
				'label' => iconv('ISO-8859-1', 'UTF-8', 'Orl sï¿½nologie:')
			),
			'attributes' => array(
				'readonly' => 'readonly',
		...
		$this->add(array(
			...
			'type' => 'Text',
			'options' => array(
				'label' => iconv('ISO-8859-1', 'UTF-8', 'Tempï¿½rature (ï¿½C)')
			),
			'attributes' => array(
		...
		$this->add(array(
			...
			'type' => 'Text',
			'options' => array(
				'label' => iconv('ISO-8859-1', 'UTF-8', 'Frï¿½quence respiratoire')
			),
			'attributes' => array(
		...
		$this->add(array(
			...
			'type' => 'Text',
			'options' => array(
				'label' => iconv('ISO-8859-1', 'UTF-8', 'Glycï¿½mie capillaire (g/l)')
			),
			'attributes' => array(
		...
		$this->add(array(
			...
			'type' => 'Zend\Form\Element\Select',
			'options' => array(
				'label' => iconv('ISO-8859-1', 'UTF-8', 'Délai :'),
				'empty_option' => 'Choisir',
				'value_options' => array(
					'10j' => '10j',
					'15j' => '15j',
		...
		$this->add(array(
			...
			'type' => 'Select',
			'options' => array(
				//'label' => iconv ( 'ISO-8859-1', 'UTF-8', 'Irradiation cervicale antï¿½rieure :' ),
				'value_options' => array(
		...
		/* tumï¿½faction cervicale antï¿½rieure */
		$this->add(array(
		...
		$this->add(array(
			...
			'attributes' => array(
				...
				'registerInArrrayValidator' => true,
				'onchange' => 'getHypertrophieSensibilite(this.value)',
			)
		));
		$this->add(array(
			'name' => 'consistance',
			...
			'options' => array(
				'value_options' => array(
					'1' => iconv('ISO-8859-1', 'UTF-8', 'Ferme'),
					'2' => iconv('ISO-8859-1', 'UTF-8', 'Dure'),
					'3' => iconv('ISO-8859-1', 'UTF-8', 'Elastique'),
					'4' => iconv('ISO-8859-1', 'UTF-8', 'Rénitente'),
				)
			),
			'attributes' => array(
				'id' => 'consistance',
		...
		$this->add(array(
			...
			'attributes' => array(
				'id' => 'libre',
				'registerInArrrayValidator' => true,
				'onchange' => 'getLabelLibre(this.value)',
			)
		));
		$this->add(array(
			'name' => 'atteinte',
		...
		$this->add(array(
			...
			'type' => 'Textarea',
			'options' => array(
				'label' => iconv('ISO-8859-1', 'UTF-8', 'Indication Préopératoire')
			),
			'attributes' => array(
		...
		$this->add(array(
			...
			'type' => 'Textarea',
			'options' => array(
				'label' => iconv('ISO-8859-1', 'UTF-8', 'Abords :')
			),
			'attributes' => array(
				'id' => 'incision'
			)
		...
		$this->add(array(
			...
			'type' => 'Textarea',
			'options' => array(
				'label' => iconv('ISO-8859-1', 'UTF-8', 'Découvertes :')
			),
			'attributes' => array(
				'id' => 'exploitation'
			)
		...
		$this->add(array(
			...
			'options' => array(
				'value_options' => array(
					'1' => iconv('ISO-8859-1', 'UTF-8', 'Loboisthmectomie droite'),
					'2' => iconv('ISO-8859-1', 'UTF-8', 'Loboisthmectomie gauche'),
					'3' => iconv('ISO-8859-1', 'UTF-8', 'Tyroidectomie Totale'),
					'4' => iconv('ISO-8859-1', 'UTF-8', 'Isthmectomie'),
				)
			),
			'attributes' => array(
				'id' => 'loboithmectomie',
		...
		$this->add(array(
			...
			'type' => 'Textarea',
			'options' => array(
				'label' => iconv('ISO-8859-1', 'UTF-8', 'Gestes :')
			),
			'attributes' => array(
				'id' => 'geste'
			)
		...
		$this->add(array(
			...
			'options' => array(
				'value_options' => array(
					...
					//'4' => iconv ( 'ISO-8859-1', 'UTF-8', 'Localisï¿½' ),
				)
			),
			'attributes' => array(
		...
		$this->add(array(
			...
			'type' => 'Textarea',
			'options' => array(
				'label' => iconv('ISO-8859-1', 'UTF-8', 'Paires craniennes :')
			),
			'attributes' => array(
				'id' => 'paires_cranienne',
				//'style' => 'height: 90px;'
		...
		$this->add(array(
			...
			'type' => 'Textarea',
			'options' => array(
				'label' => iconv('ISO-8859-1', 'UTF-8', 'Cytoponction :')
			),
			'attributes' => array(
				'id' => 'citoponction',
				//'style' => 'height: 90px;'
		...
		$this->add(array(
			...
			'type' => 'Date',
			'options' => array(
				'label' => iconv('ISO-8859-1', 'UTF-8', 'Date de sortie'),
			),
			'attributes' => array(
				//'registerInArrrayValidator' => true,
				//'onchange' => 'getListeDateFin(this.value)',
		...
		$this->add(array(
			...
			'options' => array(
				'value_options' => array(
					'1' => iconv('ISO-8859-1', 'UTF-8', 'Oreille droite'),
					'2' => iconv('ISO-8859-1', 'UTF-8', 'Oreille gauche'),
					'3' => iconv('ISO-8859-1', 'UTF-8', 'Narine droite'),
					'4' => iconv('ISO-8859-1', 'UTF-8', 'Narine gauche'),
					'5' => iconv('ISO-8859-1', 'UTF-8', 'Osophage cervicale'),
					'6' => iconv('ISO-8859-1', 'UTF-8', 'V.R.I'),
					'7' => iconv('ISO-8859-1', 'UTF-8', 'Pharynx'),
					'8' => iconv('ISO-8859-1', 'UTF-8', 'bronche'),
				)
			),
			'attributes' => array(
				'id' => 'oreille',
		...
		$this->add(array(
			...
			'options' => array(
				'value_options' => array(
					'1' => iconv('ISO-8859-1', 'UTF-8', 'déjà traitée pour la même tumeur'),
					'2' => iconv('ISO-8859-1', 'UTF-8', 'jamais traitée'),
		...
		$this->add(array(
			...
			'type' => 'Date',
			'options' => array(
				//'label' => iconv('ISO-8859-1', 'UTF-8','Date d\'apparition du 1er symptï¿½me'),
			),
			'attributes' => array(
				//'registerInArrrayValidator' => true,
				//'onchange' => 'getListeDateFin(this.value)',
		...
		/*oesophage_cervical */
		$this->add(array(
			'name' => 'oesophage_cervical',
			'type' => 'checkbox',
			'attributes' => array(
				'id' => 'oesophage_cervical',
			)
		));
		...
		$this->add(array(
			...
			'options' => array(
				'value_options' => array(
					...
					'4' => iconv('ISO-8859-1', 'UTF-8', 'Rétro-cricoéde'),
		...
		$this->add(array(
			...
			'type' => 'Textarea',
			'options' => array(
				'label' => iconv('ISO-8859-1', 'UTF-8', 'Prï¿½-laryngï¿½e :')
			),
			'attributes' => array(
				'id' => 'pre_laryngee'
			)
		...
		$this->add(array(
			...
			'type' => 'Textarea',
			'options' => array(
				'label' => iconv('ISO-8859-1', 'UTF-8', 'Trachï¿½e :')
			),
			'attributes' => array(
				'id' => 'trachee'
			)
		...
		/*Autres caractï¿½res */
		$this->add(array(
			'name' => 'autres_caractï¿½res',
			'type' => 'Textarea',
			'options' => array(
				'label' => iconv('ISO-8859-1', 'UTF-8', 'Autres caractï¿½res ')
			),
			'attributes' => array(
				'id' => 'autres_caractï¿½res'
			)
		));
		...
		$this->add(array(
			...
			'type' => 'Text',
			'options' => array(
				'label' => iconv('ISO-8859-1', 'UTF-8', 'Malade déjà traitée pour la même tumeur : ')
			),
			'attributes' => array(
		...
		$this->add(array(
			...
			'type' => 'Text',
			'options' => array(
				'label' => iconv('ISO-8859-1', 'UTF-8', 'Malade jamais traitée : ')
			),
			'attributes' => array(
		...
		$this->add(array(
			...
			'type' => 'Text',
			'options' => array(
				'label' => iconv('ISO-8859-1', 'UTF-8', 'Trachï¿½otomie en urgence : ')
			),
			'attributes' => array(
		...
		$this->add(array(
			...
			'type' => 'Text',
			'options' => array(
				'label' => iconv('ISO-8859-1', 'UTF-8', 'Otite sï¿½rieuse : ')
			),
			'attributes' => array(
				'id' => 'otite_serieuse'
			)
		...
		/*section histoire de la maladie: debut des signes, TESC, traitements reï¿½us,amelioration, aggravation, autres*/
		...
		$this->add(array(
			...
			'type' => 'Select',
			'options' => array(
				'label' => iconv('UTF-8', 'ISO-8859-1',  'OpÃƒÂ©rateur')
			),
			'attributes' => array(
				//'registerInArrrayValidator' => true,
		...
		// 				'type' => 'Select',
		// 				'options' => array (
		// 						'label' => iconv('ISO-8859-1', 'UTF-8','Opï¿½rateur (Dr.)')
		// 				),
		// 				'attributes' => array (
		// 						'registerInArrrayValidator' => true,
		// 						'onchange' => 'getservice(this.value)',
		...
		//La liste des participants ï¿½ l'opï¿½ration
		//La liste des participants ï¿½ l'opï¿½ration
		$this->add(array(
			'name' => 'aides_operateurs',
			'type' => 'TextArea',
			'options' => array(
				'label' => iconv('ISO-8859-1', 'UTF-8', 'Aides opï¿½rateurs')
			),
			'attributes' => array(
				'id' => 'aides_operateurs',
				'tabindex' => 6,
		...
		//Les complications de l'opï¿½ration
		//Les complications de l'opï¿½ration
		$this->add(array(
			'name' => 'complications',
			'type' => 'TextArea',
		...
		//Note relative au protocole opï¿½ratoire
		//Note relative au protocole opï¿½ratoire
		$this->add(array(
			'name' => 'note_audio_cro',
			'type' => 'TextArea',
