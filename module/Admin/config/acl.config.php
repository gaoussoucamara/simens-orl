    		...
    		'resources' => array(
    				...
    				'allow' => array(
    						...
    						'Facturation\Controller\Facturation' => array(
    								...
    								'informations-statistiques' =>  array('major', 'medecin'),
    								'informations-complementaires' =>  array('major', 'medecin'),
    								'informations-complementaires-ajax' =>  array('major', 'medecin'),
    								'statistiques-imprimees'=>  array('major', 'medecin', 'facturation'),
    								'statistiques-diagnostics-imprimees'=>  array('major', 'medecin'),
    								'get-tableau-statistiques-diagnostics-par-periode'=>  array('major', 'medecin'),
    								'get-tableau-statistiques-diagnostics-orl'=>  array('major', 'medecin'),
    								'get-tableau-statistiques-diagnostics-par-sous-dossier'=>  array('major', 'medecin'),
    								'get-tableau-statistiques-diagnostics-par-periode'=>  array('major', 'medecin'),
    								'get-tableau-statistiques-diagnostics-par-sexe'=>  array('major', 'medecin'),
    								'get-tableau-statistiques-diagnostics-par-age'=>  array('major', 'medecin'),
    								'get-informations-statistique-optionnelles-genre'=>  array('major', 'medecin'),
    								'get-tableau-statistiques-frequence-orl'=>  array('major', 'medecin'),
    								'get-tableau-statistiques-frequence-par-periode'=>  array('major', 'medecin'),
    								'get-tableau-statistiques-frequence-par-sous-dossier'=>  array('major', 'medecin'),
    								'get-informations-statistique-optionnelles-sous-dossier-genre'=>  array('major', 'medecin'),
    								'get-informations-statistique-optionnelles-genre-par-periode'=>  array('major', 'medecin'),
    								'statistiques-genre-imprimees'=>  array('major', 'medecin'),
    								'get-informations-statistique-optionnelles-genre-par-age'=>  array('major', 'medecin'),
    								'statistiques-frequence-imprimees'=>  array('major', 'medecin'),
    								'liste-demandes-vpa-ajax'=>  array('major', 'medecin'),
    								'liste-demandes-vpa'=>  array('major', 'medecin'),
    								'details-demande-visite'=> array('major', 'medecin'),
    								'save-result-vpa'=> array('major', 'medecin'),
    								'liste-recherche-vpa'=> array('major', 'medecin'),
    								'liste-recherche-vpa-ajax'=> array('major', 'medecin'),
    								'details-recherche-visite'=> array('major', 'medecin'),
    						...
    						*/
    						...
    						'Orl\Controller\Orl' => array(
    								...
    								'imprimer-protocole-operatoireF' => 'medecin',
    								'consultation-orl' => 'medecin',
    								'choix-dossier' => 'medecin',
    								'fiche-observation-clinique' => 'medecin',
    								'thyroide' => 'medecin',
    								'tumeur-parotidienne' => 'medecin',
    								'corps-etranger' => 'medecin',
    								'cancer' => 'medecin',
    								...
    								'recherche-visualisation-tumeur-parotidienne' => 'medecin',
    								'recherche-visualisation-corps-etranger' => 'medecin',
    								'recherche-visualisation-cancer' => 'medecin',
