function bloquerDateOperation(){
  $(function () {
    ...
    for(var cpt=0; cpt<5 ; cpt++){
    	...
    	if(amois-3 < 10){daysToDisable[j++] = annee1+'-'+lemois+'-0'+(amois-3);}else daysToDisable[j++] = annee1+'-'+lemois+'-'+(amois-3);
    	if(amois-5 < 10){daysToDisable[j++] = annee1+'-'+lemois+'-0'+(amois-5);}else daysToDisable[j++] = annee1+'-'+lemois+'-'+(amois-5);
    ...
    for(var cpt=0; cpt<5 ; cpt++){
    	...
    	if(amois-3 < 10){daysToDisable[j++] = annee2+'-'+lemois+'-0'+(amois-3);}else daysToDisable[j++] = annee2+'-'+lemois+'-'+(amois-3);
    	if(amois-5 < 10){daysToDisable[j++] = annee2+'-'+lemois+'-0'+(amois-5);}else daysToDisable[j++] = annee2+'-'+lemois+'-'+(amois-5);
    ...
    for(var cpt=0; cpt<5 ; cpt++){
    	...
    	if(amois-3 < 10){daysToDisable[j++] = annee3+'-'+lemois+'-0'+(amois-3);}else daysToDisable[j++] = annee3+'-'+lemois+'-'+(amois-3);
    	if(amois-5 < 10){daysToDisable[j++] = annee3+'-'+lemois+'-0'+(amois-5);}else daysToDisable[j++] = annee3+'-'+lemois+'-'+(amois-5);
    ...
    for(var cpt=0; cpt<5 ; cpt++){
    	...
    	if(amois-3 < 10){daysToDisable[j++] = annee4+'-'+lemois+'-0'+(amois-3);}else daysToDisable[j++] = annee4+'-'+lemois+'-'+(amois-3);
    	if(amois-5 < 10){daysToDisable[j++] = annee4+'-'+lemois+'-0'+(amois-5);}else daysToDisable[j++] = annee4+'-'+lemois+'-'+(amois-5);
    ...
    for(var cpt=0; cpt<5 ; cpt++){
    	...
    	if(amois-3 < 10){daysToDisable[j++] = annee5+'-'+lemois+'-0'+(amois-3);}else daysToDisable[j++] = annee5+'-'+lemois+'-'+(amois-3);
    	if(amois-5 < 10){daysToDisable[j++] = annee5+'-'+lemois+'-0'+(amois-5);}else daysToDisable[j++] = annee5+'-'+lemois+'-'+(amois-5);
    ...
    for(var cpt=0; cpt<5 ; cpt++){
    	...
    	if(amois-3 < 10){daysToDisable[j++] = annee6+'-'+lemois+'-0'+(amois-3);}else daysToDisable[j++] = annee6+'-'+lemois+'-'+(amois-3);
    	if(amois-5 < 10){daysToDisable[j++] = annee6+'-'+lemois+'-0'+(amois-5);}else daysToDisable[j++] = annee6+'-'+lemois+'-'+(amois-5);
    ...
    for(var cpt=0; cpt<5 ; cpt++){
    	...
    	if(amois-3 < 10){daysToDisable[j++] = annee7+'-'+lemois+'-0'+(amois-3);}else daysToDisable[j++] = annee7+'-'+lemois+'-'+(amois-3);
    	if(amois-5 < 10){daysToDisable[j++] = annee7+'-'+lemois+'-0'+(amois-5);}else daysToDisable[j++] = annee7+'-'+lemois+'-'+(amois-5);
