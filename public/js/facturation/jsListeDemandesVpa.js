    ...
    function initialisation(){
    	...
    	( {
    					...
    					"sAjaxSource": ""+tabUrl[0]+"public/facturation/liste-demandes-vpa-ajax", 
    ...
    function details(id_personne, idVpa){ 
    	...
    	var chemin = tabUrl[0]+'public/facturation/details-demande-visite';
        $.ajax({
            type: 'POST',
            url: chemin ,
    ...
    function initialisationRecherche(){
    	...
    	( {
    					...
    					"sAjaxSource": ""+tabUrl[0]+"public/facturation/liste-recherche-vpa-ajax", 
 ...
 var asInitVals = new Array();
    ...
    function vuedetails(id_personne, idVpa){ //alert(1);
    	var id_cons = $("#"+idVpa).val();
    	
    	var chemin = tabUrl[0]+'public/facturation/details-recherche-visite';
        $.ajax({
            type: 'POST',
            url: chemin ,
            data:{'id_personne':id_personne, 'id_cons':id_cons, 'encours':111, 'idVpa':idVpa},
